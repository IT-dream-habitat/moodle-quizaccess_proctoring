...
$string['privacy:metadata:screenshotpicture'] = 'The name of the screen capture image that has been taken during the quiz attempt.';
$string['privacy:metadata:captureorigin'] = 'Whether the capture was taken on a routine interval or triggered by a tab-switch violation.';
$string['privacy:metadata:quizaccess_proctoring_screenshot_logs'] = 'Moodle Quiz access Proctoring table that stores periodic screen captures.';
$string['privacy:metadata:quizaccess_proctoring_tabswitch_logs'] = 'Moodle Quiz access Proctoring table that stores tab-switch violation events.';
$string['privacy:metadata:eventtype'] = 'The type of violation event (tab switch away from the exam).';
$string['privacy:metadata:starttime'] = 'The time the student switched away from the quiz.';
$string['privacy:metadata:duration'] = 'How long, in seconds, the student was away from the quiz.';
...
$string['proctoring:sendscreenshot'] = 'Proctoring send screen capture';
$string['proctoring:sendtabswitchevent'] = 'Proctoring log tab-switch violation event';
...
$string['setting:enablescreencapture'] = 'Enable screen capture';
$string['setting:enablescreencapture_desc'] = 'If enabled, students will be prompted to share their screen and periodic screen captures will be taken during the quiz attempt, in addition to the webcam. Declining or stopping the share never blocks the attempt; it is only logged for teacher review.';
$string['setting:screenshotdelay'] = 'The delay between screen captures (seconds)';
$string['setting:screenshotdelay_desc'] = 'The given value will be the delay in seconds between each screen capture.';
$string['setting:screenshotwidth'] = 'The width of the screen capture image (pixels)';
$string['setting:screenshotwidth_desc'] = 'The given value will be the width of the screen capture image. The image height will be scaled to match this.';
$string['setting:enabletabswitchdetection'] = 'Enable tab-switch detection';
$string['setting:enabletabswitchdetection_desc'] = 'If enabled, the browser will log when a student switches to another tab, window or application during the quiz attempt, and immediately capture a webcam photo and screenshot (if screen capture is active) as evidence.';
$string['setting:screencaptureprivacynotice'] = '<strong>Privacy notice:</strong> screen capture can record far more than the exam window, including other open applications and personal information. Enabling this may require explicit consent language or a data protection impact assessment depending on your institution\'s policies and jurisdiction. Review your local requirements before enabling it.';
...
$string['violationscount'] = 'Tab switches';
$string['violationcaptured'] = 'Suspicious activity';
$string['violationstimeline'] = 'Suspicious activity timeline';
$string['violationtype'] = 'Event type';
$string['violationduration'] = 'Duration away';
$string['noviolations'] = 'No suspicious activity was recorded for this attempt.';
$string['screenshotpicture'] = 'Screen capture';
$string['warning:cameraallowwarning'] = 'Please allow camera access.';
$string['warning:sharescreenwarning'] = 'Screen sharing is required to continue this exam. Please click "Share my screen" and choose "Entire Screen" to proceed.';
$string['sharescreenbutton'] = 'Share my screen';
...
$string['wrong_during_taking_screencapture'] = 'Something went wrong while capturing your screen.';
