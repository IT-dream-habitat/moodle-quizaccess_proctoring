...
$string['privacy:metadata:quizaccess_proctoring_tabswitch_logs'] = 'Moodle Quiz access Proctoring table that stores tab-switch/focus-loss violation events.';
$string['privacy:metadata:eventtype'] = 'The type of violation event (tab switch or window focus loss).';
...
$string['setting:enabletabswitchdetection'] = 'Enable tab-switch/focus-loss detection';
...
$string['violationstimeline'] = 'Tab-switch / focus-loss violations';
$string['violationtype'] = 'Event type';
$string['violationduration'] = 'Duration away';
$string['noviolations'] = 'No tab-switch or focus-loss violations were recorded for this attempt.';
