...
$string['violationcaptured'] = 'Violation';
$string['violationstimeline'] = 'Tab-switch violations';
$string['violationtype'] = 'Event type';
$string['violationduration'] = 'Duration away';
$string['noviolations'] = 'No tab-switch violations were recorded for this attempt.';
